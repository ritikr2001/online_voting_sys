    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            <div class="row">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=VDILEWVPNTH222;Initial Catalog=Voting;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT distinct [cid] FROM [selected_candidates] WHERE ([eid] = @eid)">
                    <SelectParameters>
