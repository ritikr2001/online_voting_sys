...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="row">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" AutoGenerateDeleteButton="False" AutoGenerateEditButton="True" DataKeyNames="id" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
            <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=VDILEWVPNTH222;Initial Catalog=Voting;Integrated Security=True" ProviderName="System.Data.SqlClient" 
            ...
            DeleteCommand ="DELETE from candidates where eid = @id">
