...
<head runat="server">
    ...
    <title>VOTING - Edit Elections</title>
...
<body>
    ...
    <!--Nav bar-->
        ...
        <div class="container">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=VDILEWVPNTH222;Initial Catalog=Voting;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT candidate, COUNT(voter) AS no_of_voters FROM votes WHERE ([eid] = @eid) GROUP BY candidate ORDER BY no_of_voters DESC">
                <SelectParameters>
        ...
        <div class="container">
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="Data Source=VDILEWVPNTH222;Initial Catalog=Voting;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="
     ...
     (select v.candidate,COUNT(v.voter) as BME_votes from votes as v
      ...
      where vn.eid = @eid">
        ...
        <div class="container">
            ...
            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="Data Source=VDILEWVPNTH222;Initial Catalog=Voting;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="   select DISTINCT vn.candidate, sq1.M_votes,sq2.F_votes
    from votes as vn
    left outer join
      ...
      as sq2 on sq2.candidate = vn.candidate
       where vn.eid = @eid;">
        ...
        <div class="container">
            ...
            <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="Data Source=VDILEWVPNTH222;Initial Catalog=Voting;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="select DISTINCT vn.candidate, sq1.y1_votes,sq2.y2_votes,sq3.y3_votes,sq4.y4_votes,sq5.y5_votes
    from votes as vn
    left outer join
