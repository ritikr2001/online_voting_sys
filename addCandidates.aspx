...
<body>
    ...
    <div class="container">
        <div class="row input-field">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=VDILEWVPNTH222;Initial Catalog=Voting;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [title] FROM [elections]"></asp:SqlDataSource>
            <br />
        ...
        <div class="row">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource2" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="Data Source=VDILEWVPNTH222;Initial Catalog=Voting;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [cid] FROM [candidates] WHERE ([ename] = @ename)">
                <SelectParameters>
