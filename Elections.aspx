...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=VDILEWVPNTH222;Initial Catalog=Voting;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [elections]"></asp:SqlDataSource>
        </div>
    </div>
       </form>
